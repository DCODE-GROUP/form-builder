<template>
  <div>
    <v-toggle
        ...
        :value="localAllowToAdd"
        @input="(v) => localAllowToAdd = v">
    </v-toggle>
    ...
    <div class="grid gap-2 w-full">
      ...
      >
        <div v-for="(cell, colIndex) in row" :key="'cell-' + rowIndex + '-' + colIndex" :class="getClassForItem(grid[rowIndex], colIndex)">
          <draggable
              item-key="id"
          ...
          <p v-show="!grid[rowIndex][colIndex].length" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm text-gray-600 z-0">
