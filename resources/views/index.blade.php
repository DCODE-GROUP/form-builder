<div class="dropzone dz-clickable dz-started">
    <div class="dz-default dz-message">
        <button class="dz-button" type="button">Drop files here</button>
    </div>
    <div class="dz-preview dz-file-preview dz-processing">
        <div class="dz-image"><img data-dz-thumbnail=""></div>
        <div class="dz-details">
            <div class="dz-size"><span data-dz-size=""><strong>15.9</strong> MB</span></div>
            <div class="dz-filename"><span data-dz-name="">DSC00554.jpg</span></div>
        </div>
        ...
        <a class="dz-remove" href="javascript:undefined;" data-dz-remove="">Cancel upload</a></div>
</div>
