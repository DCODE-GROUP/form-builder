...
function ur(t) {
  return t !== null && !sr(t) && t.constructor !== null && !sr(t.constructor) && Vt(t.constructor.isBuffer) && t.constructor.isBuffer(t);
}
...
const wu = Bo("string"), Vt = Bo("function"), gs = Bo("number"), cr = (t) => t !== null && typeof t == "object", Tu = (t) => t === !0 || t === !1, vo = (t) => {
  if (!cr(t))
    return !1;
  const e = ir(t);
...
}, Ou = ln("Date"), Cu = ln("File"), Pu = (t) => !!(t && typeof t.uri < "u"), Ru = (t) => t && typeof t.getParts < "u", Iu = ln("Blob"), Du = ln("FileList"), Fu = (t) => cr(t) && Vt(t.pipe);
function Mu() {
...
const Bu = (t, e, n, { allOwnKeys: a } = {}) => (Nr(
  e,
  (i, c) => {
    n && Vt(i) ? Object.defineProperty(t, c, {
...
function oc(t) {
  return !!(t && Vt(t.append) && t[vs] === "FormData" && t[Ur]);
}
const ac = (t) => {
  ...
  return n(t);
}, ic = ln("AsyncFunction"), sc = (t) => t && (cr(t) || Vt(t)) && Vt(t.then) && Vt(t.catch), Ss = ((t, e) => t ? setImmediate : e ? ((n, a) => (Vn.addEventListener(
  "message",
  ({ source: i, data: c }) => {
    i === Vn && c === n && a.length && a.shift()();
  },
  !1
), (i) => {
  a.push(i), Vn.postMessage(n, "*");
}))(`axios@${Math.random()}`, []) : (n) => setTimeout(n))(typeof setImmediate == "function", Vt(Vn.postMessage)), lc = typeof queueMicrotask < "u" ? queueMicrotask.bind(Vn) : typeof process < "u" && process.nextTick || Ss, Es = (t) => t != null && Vt(t[Ur]), uc = (t) => t != null && Mr(t, Ur) && Es(t), W = {
  isArray: Wn,
  isArrayBuffer: ms,
  isBuffer: ur,
  isFormData: Lu,
...
}, ka = typeof window < "u" && typeof document < "u", Sa = typeof navigator == "object" && navigator || void 0, Fc = ka && (!Sa || ["ReactNative", "NativeScript", "NS"].indexOf(Sa.product) < 0), Mc = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Lc = ka && window.location.href || "http://localhost", Uc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: ka,
...
function Is(t) {
  function e(n, a, i, c) {
    ...
    return r = !r && W.isArray(i) ? i.length : r, o ? (W.hasOwnProp(i, r) ? i[r] = W.isArray(i[r]) ? i[r].concat(a) : [i[r], a] : i[r] = a, !s) : ((!W.hasOwnProp(i, r) || !W.isObject(i[r])) && (i[r] = []), e(n, a, i[r], c) && W.isArray(i[r]) && (i[r] = kc(i[r])), !s);
  }
...
const jr = {
  ...
  transformRequest: [
    function(e, n) {
      ...
      return c || i ? (n.setContentType("application/json", !1), Vc(e)) : e;
    }
  ],
  transformResponse: [
    function(e) {
...
const Va = "1.18.0", Di = 64 * 1024, { isFunction: oo } = W, ld = (t) => encodeURIComponent(t).replace(
  /%([0-9A-F]{2})/gi,
  (e, n) => String.fromCharCode(parseInt(n, 16))
), Fi = (t) => {
  if (!W.isString(t))
  ...
  return async (g) => {
    ...
    try {
      ...
      if (h && S !== "get" && S !== "head" && (D || R)) {
        if (Ee = Ee ?? await v(k, E), Ee !== 0 || R) {
          let U = new c(y, {
            method: "POST",
            body: E,
            duplex: "half"
          }), B;
          if (W.isFormData(E) && (B = U.headers.get("content-type")) && k.setContentType(B), U.body) {
            const [Q, q] = D && Oi(
              Ee,
              Co(Ci(D))
            ) || [];
...
zo.transitional = function(e, n, a) {
  function i(c, r) {
    return "[Axios v" + Va + "] Transitional option '" + c + "'" + r + (a ? ". " + a : "");
  }
  return (c, r, s) => {
    if (e === !1)
      throw new Ce(
...
let vd = class js {
  constructor(e) {
    ...
    this.promise.then((i) => {
      ...
      a.reason || (a.reason = new kr(c, r, s), n(a.reason));
    });
  }
  /**
          ...
          var n = {
            ...
            260: (
              ...
              (function(r, s, o) {
                ...
                if ((!Y || typeof j != "function" || j === Function.prototype) && (j = function() {
                  ...
                  for (J in he)
                    d[J] && S(d[J], j);
                if ((!Y || !k || k === z) && (k = j.prototype, Y))
                  for (J in he)
                    d[J] && S(d[J].prototype, k);
                if (Y && y(D) !== k && S(D, k), u && !p(k, H)) {
                  ae = !0, g(k, H, { get: function() {
            ...
            3331: (
              ...
              (function(r, s, o) {
                var l = o(7854), u = o(9781), d = o(4019), h = o(8880), p = o(2248), f = o(7293), m = o(5787), v = o(9958), g = o(7466), y = o(7067), S = o(1179), E = o(9518), A = o(7674), w = o(8006).f, P = o(3070).f, C = o(1285), D = o(8003), j = o(9909), k = j.get, z = j.set, $ = "ArrayBuffer", H = "DataView", K = "prototype", Y = "Wrong length", ae = "Wrong index", J = l[$], he = J, ce = l[H], ye = ce && ce[K], Oe = Object.prototype, Ee = l.RangeError, Ue = S.pack, Ne = S.unpack, be = function(ee) {
                  ...
                  var tt = k(Ke.buffer).bytes, _e = Re + Ke.byteOffset, G = tt.slice(_e, _e + ne);
                  return ge ? G : G.reverse();
                }, I = function(ee, ne, le, ge, Re, Ke) {
                  var tt = y(le), _e = k(ee);
                  if (tt + ne > _e.byteLength) throw Ee(ae);
                  for (var G = k(_e.buffer).bytes, X = tt + _e.byteOffset, re = ge(+Re), de = 0; de < ne; de++) G[X + de] = re[Ke ? de : ne - de - 1];
                };
                if (!d)
                  he = function(ne) {
                    m(this, he, $);
                    ...
                    var Re = k(ne).byteLength, Ke = v(le);
            ...
            8457: (
              ...
              (function(r, s, o) {
                ...
                r.exports = function(g) {
                  var y = u(g), S = typeof this == "function" ? this : Array, E = arguments.length, A = E > 1 ? arguments[1] : void 0, w = A !== void 0, P = m(y), C = 0, D, j, k, z, $, H;
                  if (w && (A = l(A, E > 2 ? arguments[2] : void 0, 2)), P != null && !(S == Array && h(P)))
                    for (z = P.call(y), $ = z.next, j = new S(); !(k = $.call(z)).done; C++)
                      H = w ? d(z, A, [k.value, C], !0) : k.value, f(j, C, H);
                  else
            ...
            2092: (
              ...
              (function(r, s, o) {
                var l = o(9974), u = o(8361), d = o(7908), h = o(7466), p = o(5417), f = [].push, m = function(v) {
                  ...
                  return function(C, D, j, k) {
                    for (var z = d(C), $ = u(z), H = l(D, j, 3), K = h($.length), Y = 0, ae = k || p, J = g ? ae(C, K) : y || w ? ae(C, 0) : void 0, he, ce; K > Y; Y++) if ((P || Y in $) && (he = $[Y], ce = H(he, Y, z), v))
                      if (g) J[Y] = ce;
                      else if (ce) switch (v) {
                        case 3:
                          return !0;
            ...
            654: (
              ...
              (function(r, s, o) {
                ...
                r.exports = function(k, z, $, H, K, Y, ae) {
                  u($, z, H);
                  var J = function(R) {
                    if (R === K && Ee) return Ee;
                  ...
                  }, he = z + " Iterator", ce = !1, ye = k.prototype, Oe = ye[w] || ye["@@iterator"] || K && ye[K], Ee = !A && Oe || J(K), Ue = z == "Array" && ye.entries || Oe, Ne, be, xe;
                  if (Ue && (Ne = d(Ue.call(new k())), E !== Object.prototype && Ne.next && (!g && d(Ne) !== E && (h ? h(Ne, E) : typeof Ne[w] != "function" && f(Ne, w, j)), p(Ne, he, !0, !0), g && (y[he] = j))), K == C && Oe && Oe.name !== C && (ce = !0, Ee = function() {
                    return Oe.call(this);
              ...
              (function(r, s, o) {
                ...
                r.exports = function(E, A, w, P) {
                  ...
                  if (!D || !j || E === "replace" && !(m && v && !y) || E === "split" && !S) {
                    var k = /./[C], z = w(C, ""[E], function(K, Y, ae, J, he) {
                      return Y.exec === h ? D && !he ? { done: !0, value: k.call(Y, ae, J) } : { done: !0, value: K.call(ae, Y, J) } : { done: !1 };
                    }, {
                      REPLACE_KEEPS_$0: v,
                  ...
                  return y !== void 0 && (y = l(y), w = h), d.call(S, w, function(P, C) {
                    ...
                    switch (C.charAt(0)) {
                      ...
                      default:
                        ...
                        if (j > A) {
                          var k = u(j / 10);
                          return k === 0 ? P : k <= A ? g[k - 1] === void 0 ? C.charAt(1) : g[k - 1] + C.charAt(1) : P;
                        }
                        D = g[j - 1];
                    }
                    return D === void 0 ? "" : D;
              ...
              (function(r, s, o) {
                ...
                r.exports = !v || u(function() {
                  ...
                  for (var A = f(S), w = arguments.length, P = 1, C = h.f, D = p.f; w > P; )
                    for (var j = m(arguments[P++]), k = C ? d(j).concat(C(j)) : d(j), z = k.length, $ = 0, H; z > $; )
                      H = k[$++], (!l || D.call(j, H)) && (A[H] = j[H]);
                  return A;
                } : v;
              })
            ),
            ...
            30: (
              ...
              (function(r, s, o) {
                var l = o(9670), u = o(6048), d = o(748), h = o(3501), p = o(490), f = o(317), m = o(6200), v = ">", g = "<", y = "prototype", S = "script", E = m("IE_PROTO"), A = function() {
                  ...
                  var k = f("iframe"), z = "java" + S + ":", $;
                  return k.style.display = "none", p.appendChild(k), k.src = String(z), $ = k.contentWindow.document, $.open(), $.write(w("document.F=Object")), $.close(), $.F;
                }, D, j = function() {
                  try {
                  ...
                  j = D ? P(D) : C();
                  for (var k = d.length; k--; ) delete j[y][d[k]];
                  return j();
                };
            ...
            2261: (
              ...
              (function(r, s, o) {
                ...
                g && (p = function(S) {
                  var E = this, A, w, P, C, D = m && E.sticky, j = l.call(E), k = E.source, z = 0, $ = S;
...
`) && (k = "(?: " + k + ")", $ = " " + $, z++), w = new RegExp("^(?:" + k + ")", j)), v && (w = new RegExp("^" + k + "$(?!\\s)", j)), f && (A = E.lastIndex), P = d.call(D ? w : E, $), D ? P ? (P.input = P.input.slice(z), P[0] = P[0].slice(z), P.index = E.lastIndex, E.lastIndex += P[0].length) : E.lastIndex = 0 : f && P && (E.lastIndex = E.global ? P.index + P[0].length : A), v && P && P.length > 1 && h.call(P[0], w, function() {
            ...
            3197: (
              ...
              (function(r) {
                var s = 2147483647, o = 36, l = 1, u = 26, d = 38, h = 700, p = 72, f = 128, m = "-", v = /[^\0-\u007E]/, g = /[.\u3002\uFF0E\uFF61]/g, y = "Overflow: input needs wider integers to process", S = o - l, E = Math.floor, A = String.fromCharCode, w = function(j) {
                  for (var k = [], z = 0, $ = j.length; z < $; ) {
                    var H = j.charCodeAt(z++);
                    if (H >= 55296 && H <= 56319 && z < $) {
                      var K = j.charCodeAt(z++);
                      (K & 64512) == 56320 ? k.push(((H & 1023) << 10) + (K & 1023) + 65536) : (k.push(H), z--);
                    } else
                      k.push(H);
                  }
                  return k;
                  ...
                  var $ = 0;
                  for (j = z ? E(j / h) : j >> 1, j += E(j / k); j > S * u >> 1; $ += o)
                    j = E(j / S);
                  return E($ + (S + 1) * j / (j + d));
                }, D = function(j) {
                  var k = [];
                    ...
                    for (H += (ce - $) * ye, $ = ce, Y = 0; Y < j.length; Y++) {
                      ...
                      if (ae == $) {
                        for (var Oe = H, Ee = o; ; Ee += o) {
                          ...
                          k.push(A(P(Ue + Ne % be))), Oe = E(Ne / be);
                        }
                        k.push(A(P(Oe))), K = C(H, ye, he == J), H = 0, ++he;
                      }
                    }
                    ++H, ++$;
                  }
                ...
                r.exports = function(j) {
                  var k = [], z = j.toLowerCase().replace(g, ".").split("."), $, H;
                  for ($ = 0; $ < z.length; $++)
                    H = z[$], k.push(v.test(H) ? "xn--" + D(H) : H);
                  return k.join(".");
                };
              })
            ),
                ...
                d ? (xe || (Y.f = q, K.f = Z, U(T, "buffer"), U(T, "byteOffset"), U(T, "byteLength"), U(T, "length")), l({ target: "Object", stat: !0, forced: !xe }, {
                  ...
                  xe ? h && (G = ne(function(Pe, Te, ze, Ie) {
                    ...
                    if (!C(Te))
                      ...
                      if (Ie === void 0) {
                        if (Gt % ge || (Ve = Gt - Fe, Ve < 0)) throw Ue(I);
                      } else if (Ve = y(Ie) * ge, Ve + Fe > Gt) throw Ue(I);
                      at = Ve / ge;
            ...
            7321: (
              ...
              (function(r, s, o) {
                ...
                r.exports = function(v) {
                  var g = l(v), y = arguments.length, S = y > 1 ? arguments[1] : void 0, E = S !== void 0, A = d(g), w, P, C, D, j, k;
                  if (A != null && !h(A))
                    for (j = A.call(g), k = j.next, g = []; !(D = k.call(j)).done; )
                      g.push(D.value);
...
\v\f\r                　\u2028\u2029\uFEFF`;
            ...
            2222: (
              ...
              (function(r, s, o) {
                ...
                }), C = g("concat"), D = function(k) {
                  if (!h(k)) return !1;
                  var z = k[E];
                  return z !== void 0 ? !!z : d(k);
                }, j = !P || !C;
            ...
            7042: (
              ...
              (function(r, s, o) {
                ...
                l({ target: "Array", proto: !0, forced: !y }, {
                  slice: function(P, C) {
                    var D = f(this), j = p(D.length), k = h(P, j), z = h(C === void 0 ? j : C, j), $, H, K;
                    if (d(D) && ($ = D.constructor, typeof $ == "function" && ($ === Array || d($.prototype)) ? $ = void 0 : u($) && ($ = $[S], $ === null && ($ = void 0)), $ === Array || $ === void 0))
                      return E.call(D, k, z);
                    for (H = new ($ === void 0 ? Array : $)(A(z - k, 0)), K = 0; k < z; k++, K++) k in D && m(H, K, D[k]);
                    return H.length = K, H;
                  }
                });
              })
            ...
            561: (
              ...
              (function(r, s, o) {
                ...
                l({ target: "Array", proto: !0, forced: !g }, {
                  splice: function(P, C) {
                    var D = p(this), j = h(D.length), k = u(P, j), z = arguments.length, $, H, K, Y, ae, J;
                    if (z === 0 ? $ = H = 0 : z === 1 ? ($ = 0, H = j - k) : ($ = z - 2, H = S(y(d(C), 0), j - k)), j + $ - H > E)
                      throw TypeError(A);
                    for (K = f(D, H), Y = 0; Y < H; Y++)
                      ae = k + Y, ae in D && m(K, Y, D[ae]);
                    if (K.length = H, $ < H) {
                      for (Y = k; Y < j - H; Y++)
                ...
                l("replace", 2, function(E, A, w, P) {
                  ...
                  return [
                    ...
                    function(k, z) {
                      ...
                      var H = u(k), K = String(this), Y = typeof z == "function";
                      Y || (z = String(z));
                      var ae = H.global;
                      if (ae) {
                        var J = H.unicode;
            ...
            3123: (
              ...
              (function(r, s, o) {
                ...
                l("split", 2, function(P, C, D) {
                  ...
                  ".".split(/()()/).length > 1 || "".split(/.?/).length ? j = function(k, z) {
                    var $ = String(h(this)), H = z === void 0 ? A : z >>> 0;
                    if (H === 0) return [];
                    if (k === void 0) return [$];
                    if (!u(k))
                      return C.call($, k, H);
                    for (var K = [], Y = (k.ignoreCase ? "i" : "") + (k.multiline ? "m" : "") + (k.unicode ? "u" : "") + (k.sticky ? "y" : ""), ae = 0, J = new RegExp(k.source, Y + "g"), he, ce, ye; (he = g.call(J, $)) && (ce = J.lastIndex, !(ce > ae && (K.push($.slice(ae, he.index)), he.length > 1 && he.index < $.length && S.apply(K, he.slice(1)), ye = he[0].length, ae = ce, K.length >= H))); )
                      J.lastIndex === he.index && J.lastIndex++;
                    return ae === $.length ? (ye || !J.test("")) && K.push("") : K.push($.slice(ae)), K.length > H ? K.slice(0, H) : K;
                  } : "0".split(void 0, 0).length ? j = function(k, z) {
                    return k === void 0 && z === 0 ? [] : C.call(this, k, z);
                  } : j = C, [
                    ...
                    // the 'y' flag.
                    function(k, z) {
                      var $ = D(j, k, this, z, j !== C);
                      if ($.done) return $.value;
                      var H = d(k), K = String(this), Y = p(H, RegExp), ae = H.unicode, J = (H.ignoreCase ? "i" : "") + (H.multiline ? "m" : "") + (H.unicode ? "u" : "") + (w ? "y" : "g"), he = new Y(w ? H : "^(?:" + H.source + ")", J), ce = z === void 0 ? A : z >>> 0;
                      if (ce === 0) return [];
            ...
            285: (
              ...
              (function(r, s, o) {
                ...
                }, X = {}, re = {}, de = {}, we = {}, je = {}, Pe = {}, Te = {}, ze = {}, Ie = {}, Ae = {}, Fe = {}, He = {}, Ve = {}, at = {}, Gt = {}, Mn = {}, $t = {}, Wt = {}, fr = {}, un = {}, St = {}, Yt = function(M, ue, se, pe) {
                ...
                if (u && p(hr, {
                  ...
                  port: Mt(Xr, function(M) {
                    var ue = z(this);
                    ge(ue) || (M = String(M), M == "" ? ue.port = null : Yt(ue, M, Ve));
                  }),
...
function Fd(t, e, n, a, i, c) {
  ...
  return _(), oe("div", Sd, [
    ...
    V("div", {
      class: nt(["dropzone", n.modelValue.class]),
      ref: "dropzone"
    }, [...e[2] || (e[2] = [
...
function Md() {
  return ki || (ki = 1, (function(t, e) {
    ...
    ce[c] = ce[r] = ce[A] = ce[w] = ce[s] = ce[o] = ce[P] = ce[C] = ce[D] = ce[j] = ce[k] = ce[h] = ce[p] = ce[f] = ce[v] = ce[g] = ce[y] = ce[S] = ce[z] = ce[$] = ce[H] = ce[K] = !0, ce[l] = ce[u] = ce[E] = !1;
    ...
    function De(O, te, fe) {
      var ke = O[te];
      (!(ge.call(O, te) && di(ke, fe)) || fe === void 0 && !(te in O)) && (O[te] = fe);
    }
    function Qe(O, te) {
    ...
    function lt(O, te, fe, ke, Et, Ut, mn) {
      ...
      return F(gi || O, function(_o, no) {
        gi && (no = _o, _o = O[no]), De(Nt, no, lt(_o, te, fe, ke, no, O, mn));
      }), Nt;
    }
    function Lt(O) {
      return to(O) ? re(O) : {};
    ...
    function jl(O, te, fe) {
      var ke = te ? fe(B(O), !0) : B(O);
      return L(ke, R, new O.constructor());
    }
    function kl(O) {
    ...
    (ze && Ln(new ze(new ArrayBuffer(1))) != w || Ie && Ln(new Ie()) != h || Ae && Ln(Ae.resolve()) != m || Fe && Ln(new Fe()) != g || He && Ln(new He()) != E) && (Ln = function(O) {
      var te = Re.call(O), fe = te == f ? O.constructor : void 0, ke = fe ? Un(fe) : void 0;
      if (ke)
        switch (ke) {
          case at:
            return w;
...
function Vd(t, e, n, a, i, c) {
  var r, s, o;
  return _(), oe("div", {
    class: nt((r = n.modelValue) == null ? void 0 : r.class)
  }, [
    ...
    (o = n.modelValue) != null && o.hint ? (_(), oe("p", kd, $e(n.modelValue.hint), 1)) : Me("", !0)
  ], 2);
}
const Ro = /* @__PURE__ */ bt(Ud, [["render", Vd]]), Hs = {
  beforeMount(t, e) {
...
function Wd(t, e, n, a, i, c) {
  ...
  return et((_(), oe("div", {
    class: nt([(s = n.modelValue) == null ? void 0 : s.class, "relative"])
  }, [
    V("input", {
      type: "hidden",
    ...
    V("div", {
      class: nt(["input-base bg-white cursor-pointer", { "text-gray-400": !i.selectedLabel && ((o = n.modelValue) == null ? void 0 : o.placeholder) }]),
...
function rf(t, e, n, a, i, c) {
  ...
  const r = on("XClose");
  return _(), oe("div", {
    class: nt(["signature-pad", (s = n.modelValue) == null ? void 0 : s.class])
  }, [
    V("input", {
      type: "hidden",
...
function vf(t, e, n, a, i, c) {
  var r;
  return _(), oe("div", {
    class: nt(["paragraph text-gray-600", (r = n.modelValue) == null ? void 0 : r.class])
  }, [
...
function $f(t, e) {
  ...
  try {
    var a = n.locale, i = a === void 0 ? Ga : a, c = n.backupDate, r = c === void 0 ? /* @__PURE__ */ new Date() : c, s = Vf(t, e, i), o = s.year, l = s.month, u = s.day, d = s.hour, h = s.minute, p = s.second, f = s.millisecond, m = s.isPM, v = s.date, g = s.offset, y = s.weekday, S = s.week;
    if (v)
      return v;
    var E = [o, l, u, d, h, p, f];
    ...
    var w, P = Nf(E, r);
    return g !== void 0 ? (P[6] += g * 60 * 1e3, w = kf.apply(void 0, Hi(P))) : w = jf.apply(void 0, Hi(P)), y !== void 0 && w.getDay() !== y ? /* @__PURE__ */ new Date(NaN) : w;
  } catch {
...
const lh = {
  ...
  width: "1em",
  height: "1em"
}, uh = /* @__PURE__ */ V("path", { d: "M810.005 274.005 572.011 512l237.994 237.995-60.01 60.01L512 572.011 274.005 810.005l-60.01-60.01L451.989 512 213.995 274.005l60.01-60.01L512 451.989l237.995-237.994z" }, null, -1), ch = [
  uh
];
function dh(t, e) {
...
const fh = {
  ...
  d: "M0 0h24v24H0z",
  fill: "none"
}, null, -1), ph = /* @__PURE__ */ V("path", { d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" }, null, -1), vh = /* @__PURE__ */ V("path", { d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z" }, null, -1), mh = [
  hh,
  ph,
  vh
];
...
function Ah(t, {
  ...
  const i = Kf(iu(t, "lang")), c = qe(), r = () => c.value, s = qe(!1), o = an(() => !a.disabled && (typeof a.open == "boolean" ? a.open : s.value)), l = () => {
    ...
    return (D = a["onUpdate:value"]) == null || D.call(a, k), (j = a.onChange) == null || j.call(a, k, P), C && u(), k;
  ...
  const y = (w, P) => {
    ...
    return ie("div", {
      ...
      onClick: () => {
        var k;
        const z = (k = D.onClick) == null ? void 0 : k.call(D);
        z && v(z);
      }
    }, [D.text]))]);
  };
...
function qh(t, e, n, a, i, c) {
  ...
  return _(), oe("div", {
    class: nt(["v-datepicker", (s = n.modelValue) == null ? void 0 : s.class])
  }, [
    V("input", {
      type: "hidden",
      name: n.modelValue.name,
...
function ap(t, e, n, a, i, c) {
  ...
  return _(), oe("div", null, [
    V("div", ep, [
      V("span", tp, $e((r = n.modelValue) == null ? void 0 : r.label), 1),
      V("div", null, [
        t.editable ? et((_(), oe("input", {
          key: 0,
          name: n.modelValue.name,
  ...
  return _(), oe("label", {
    ...
    n.labelText || t.$slots.label ? (_(), oe("span", lp, [
      t.$slots.label ? xn(t.$slots, "label", { key: 0 }) : (_(), oe(Pt, { key: 1 }, [
        V("span", { innerHTML: n.labelText }, null, 8, up),
...
function Fp(t, e, n, a, i, c) {
  ...
  return _(), oe("div", {
    class: nt(["grid space-y-2", (o = n.modelValue) == null ? void 0 : o.class])
  }, [
    ie(r, {
      field: "full_address",
...
function Xp(t, e, n, a, i, c) {
  ...
  return _(), oe("div", null, [
    n.modelValue.hint ? (_(), oe("p", Vp, $e(n.modelValue.hint), 1)) : Me("", !0),
    V("div", $p, [
        ...
        o.filter((u) => u.length).length ? (_(), oe("div", Bp, [
          (_(!0), oe(Pt, null, bn(o, (u, d) => {
            ...
            return _(), oe("div", {
              ...
              class: nt(c.getClassForItem(c.grid[l], d) + (c.canRemove ? " pr-[40px]" : ""))
            }, [
          ...
          c.canRemoveRow(l) && c.originalGrid ? (_(), oe("a", {
            key: 0,
            class: nt(["cursor-pointer absolute top-2.5 right-[12px]", { "!top-[38px]": l === 0 }]),
...
var Se, ft, Ye, ut, kn, xo, ht, On, or, zt, Rr, An, lo, wt, nr = !1, Uo = !1, No = [], Nn, tn, fa, ha, rs, os, wr, _n, Ir, Dr = !1, uo = !1, So, Ct, pa = [], Oa = !1, jo = [], Qo = typeof document < "u", co = El, as = Br || Tn ? "cssFloat" : "float", Fv = Qo && !wv && !El && "draggable" in document.createElement("div"), Cl = (function() {
  if (Qo) {
    if (Tn)
      return !1;
...
Be.prototype = /** @lends Sortable.prototype */
{
  ...
  _prepareDragStart: function(e, n, a) {
    ...
    if (a && !Se && a.parentNode === c) {
      var l = ct(a);
      if (ut = c, Se = a, ft = Se.parentNode, kn = Se.nextSibling, xo = a, lo = r.group, Be.dragged = Se, Nn = {
        target: Se,
        clientX: (n || e).clientX,
        clientY: (n || e).clientY
  ...
  _onDragOver: function(e) {
    ...
    if (Uo = !1, l && !s.disabled && (u ? d || (r = ft !== ut) : wt === this || (this.lastPutMode = lo.checkPull(this, l, Se, e)) && o.checkPut(this, l, Se, e))) {
      ...
      if (!E || Vv(e, p, this) && !E.animated) {
        ...
        c = ct(a);
        var w = 0, P, C = Se.parentNode !== n, D = !Mv(Se.animated && Se.toRect || i, a.animated && a.toRect || c, p), j = p ? "top" : "left", k = es(a, "top", "top") || es(Se, "top", "top"), z = k ? k.scrollTop : void 0;
        ...
        if (ae !== !1)
          return (ae === 1 || ae === -1) && (Y = ae === 1), Oa = !0, setTimeout(jv, 30), g(), Y && !K ? n.appendChild(Se) : a.parentNode.insertBefore(Se, Y ? K : a), k && Ol(k, 0, z - k.scrollTop), ft = Se.parentNode, P !== void 0 && !uo && (So = Math.abs(P - ct(a)[j])), S(), y(!0);
      }
      if (n.contains(Se))
        return y(!1);
    }
  ...
  _nulling: function() {
    jt("nulling", this), ut = Se = ft = Ye = kn = ht = xo = On = Nn = tn = wr = zt = An = or = Rr = _n = Ir = wt = lo = Be.dragged = Be.ghost = Be.clone = Be.active = null, jo.forEach(function(e) {
      e.checked = !0;
    }), jo.length = fa = ha = 0;
  },
...
function Gv() {
  ...
  return t.prototype = {
    ...
    nulling: function() {
      ko = Pa = Tr = Ra = Ar = ma = ga = null, gt.length = 0;
    },
...
var ya = Al(function(t, e, n, a) {
  if (e.scroll) {
    ...
    var d = 0, h = Tr;
    do {
      var p = h, f = ct(p), m = f.top, v = f.bottom, g = f.left, y = f.right, S = f.width, E = f.height, A = void 0, w = void 0, P = p.scrollWidth, C = p.scrollHeight, D = Le(p), j = p.scrollLeft, k = p.scrollTop;
      ...
      var z = A && (Math.abs(y - i) <= r && j + S < P) - (Math.abs(g - i) <= r && !!j), $ = w && (Math.abs(v - c) <= r && k + E < C) - (Math.abs(m - c) <= r && !!k);
      if (!gt[d])
        for (var H = 0; H <= d; H++)
          gt[H] || (gt[H] = {});
      (gt[d].vx != z || gt[d].vy != $ || gt[d].el !== p) && (gt[d].el = p, gt[d].vx = z, gt[d].vy = $, clearInterval(gt[d].pid), (z != 0 || $ != 0) && (l = !0, gt[d].pid = setInterval((function() {
        ...
        typeof u == "function" && u.call(Be.dragged.parentNode[Rt], Y, K, t, ko, gt[this.layer].el) !== "continue" || Ol(gt[this.layer].el, Y, K);
      }).bind({
        layer: d
      }), 24))), d++;
...
var We = [], Bt = [], gr, nn, yr = !1, kt = !1, er = !1, it, br, ho;
function Kv() {
  function t(e) {
    for (var n in this)
  ...
  return t.prototype = {
    ...
    drop: function(n) {
      ...
      if (a) {
        ...
        if (er && this.isMultiDrag) {
          if (kt = !1, (c[Rt].options.sort || c !== i) && We.length > 1) {
    ...
    eventProperties: function() {
      ...
      return We.forEach(function(c) {
        ...
        var r;
        kt && c !== it ? r = -1 : kt ? r = pt(c, ":not(." + n.options.selectedClass + ")") : r = pt(c), i.push({
          multiDragElement: c,
          index: r
        });
      }), {
        ...
        (function(i) {
          ...
          "4df4": (
            ...
            (function(i, c, r) {
              ...
              i.exports = function(m) {
                var v = o(m), g = typeof this == "function" ? this : Array, y = arguments.length, S = y > 1 ? arguments[1] : void 0, E = S !== void 0, A = p(v), w = 0, P, C, D, j, k, z;
                if (E && (S = s(S, y > 2 ? arguments[2] : void 0, 2)), A != null && !(g == Array && u(A)))
                  for (j = A.call(v), k = j.next, C = new g(); !(D = k.call(j)).done; w++)
          ...
          5319: (
            ...
            (function(i, c, r) {
              ...
              s("replace", 2, function(A, w, P, C) {
                var D = C.REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE, j = C.REPLACE_KEEPS_$0, k = D ? "$" : "$0";
                return [
                  // `String.prototype.replace` method
                  ...
                  function($, H) {
                    if (!D && j || typeof H == "string" && H.indexOf(k) === -1) {
                      var K = P(w, $, this, H);
          ...
          "7c73": (
            ...
            (function(i, c, r) {
              var s = r("825a"), o = r("37e8"), l = r("7839"), u = r("d012"), d = r("1be4"), h = r("cc12"), p = r("f772"), f = ">", m = "<", v = "prototype", g = "script", y = p("IE_PROTO"), S = function() {
                ...
                var D = h("iframe"), j = "java" + g + ":", k;
                return D.style.display = "none", d.appendChild(D), D.src = String(j), k = D.contentWindow.document, k.open(), k.write(E("document.F=Object")), k.close(), k.F;
              }, P, C = function() {
                try {
              ...
              u[y] = !0, i.exports = Object.create || function(j, k) {
                var z;
                return j !== null ? (S[v] = s(j), z = new S(), S[v] = null, z[y] = j) : z = C(), k === void 0 ? z : o(z, k);
              };
            })
          ),
          /***/
          "7dd0": (
            ...
            (function(i, c, r) {
              ...
              i.exports = function(D, j, k, z, $, H, K) {
                o(k, j, z);
                var Y = function(be) {
                  if (be === $ && ye) return ye;
          ...
          9263: (
            ...
            (function(i, c, r) {
              ...
              m && (d = function(g) {
                var y = this, S, E, A, w, P = p && y.sticky, C = s.call(y), D = y.source, j = 0, k = g;
                return P && (C = C.replace("y", ""), C.indexOf("g") === -1 && (C += "g"), k = String(g).slice(y.lastIndex), y.lastIndex > 0 && (!y.multiline || y.multiline && g[y.lastIndex - 1] !== `
`) && (D = "(?: " + D + ")", k = " " + k, j++), E = new RegExp("^(?:" + D + ")", C)), f && (E = new RegExp("^" + D + "$(?!\\s)", C)), h && (S = y.lastIndex), A = l.call(P ? E : y, k), P ? A ? (A.input = A.input.slice(j), A[0] = A[0].slice(j), A.index = y.lastIndex, y.lastIndex += A[0].length) : y.lastIndex = 0 : h && A && (y.lastIndex = y.global ? A.index + A[0].length : S), f && A && A.length > 1 && u.call(A[0], E, function() {
          ...
          "99af": (
            ...
            (function(i, c, r) {
              ...
              s({ target: "Array", proto: !0, forced: C }, {
                concat: function(j) {
                  var k = d(this), z = f(k, 0), $ = 0, H, K, Y, ae, J;
                  for (H = -1, Y = arguments.length; H < Y; H++)
                    if (J = H === -1 ? k : arguments[H], P(J)) {
          ...
          a434: (
            ...
            (function(i, c, r) {
              ...
              s({ target: "Array", proto: !0, forced: !v || !g }, {
                splice: function(P, C) {
                  var D = d(this), j = u(D.length), k = o(P, j), z = arguments.length, $, H, K, Y, ae, J;
                  if (z === 0 ? $ = H = 0 : z === 1 ? ($ = 0, H = j - k) : ($ = z - 2, H = S(y(l(C), 0), j - k)), j + $ - H > E)
                    throw TypeError(A);
                  for (K = h(D, H), Y = 0; Y < H; Y++)
                    ae = k + Y, ae in D && p(K, Y, D[ae]);
                  if (K.length = H, $ < H) {
                    for (Y = k; Y < j - H; Y++)
                      ae = Y + H, J = Y + $, ae in D ? D[J] = D[ae] : delete D[J];
                    for (Y = j; Y > j - H + $; Y--) delete D[Y - 1];
          ...
          a4d3: (
            /***/
            (function(i, c, r) {
              var s = r("23e7"), o = r("da84"), l = r("d066"), u = r("c430"), d = r("83ab"), h = r("4930"), p = r("fdbf"), f = r("d039"), m = r("5135"), v = r("e8b5"), g = r("861d"), y = r("825a"), S = r("7b0b"), E = r("fc6a"), A = r("c04e"), w = r("5c6c"), P = r("7c73"), C = r("df75"), D = r("241c"), j = r("057f"), k = r("7418"), z = r("06cf"), $ = r("9bf2"), H = r("d1e7"), K = r("9112"), Y = r("6eeb"), ae = r("5692"), J = r("f772"), he = r("d012"), ce = r("90e3"), ye = r("b622"), Oe = r("e538"), Ee = r("746f"), Ue = r("d44e"), Ne = r("69f3"), be = r("b727").forEach, xe = J("hidden"), R = "Symbol", F = "prototype", T = ye("toPrimitive"), L = Ne.set, b = Ne.getterFor(R), x = Object[F], I = o.Symbol, N = l("JSON", "stringify"), U = z.f, B = $.f, Q = j.f, q = H.f, Z = ae("symbols"), ee = ae("op-symbols"), ne = ae("string-to-symbol-registry"), le = ae("symbol-to-string-registry"), ge = ae("wks"), Re = o.QObject, Ke = !Re || !Re[F] || !Re[F].findChild, tt = d && f(function() {
                return P(B({}, "a", {
                  get: function() {
                ...
                var Ve = A(Fe, !0);
                return y(He), m(Z, Ve) ? (He.enumerable ? (m(Ae, xe) && Ae[xe][Ve] && (Ae[xe][Ve] = !1), He = P(He, { enumerable: w(0, !1) })) : (m(Ae, xe) || B(Ae, xe, w(1, {})), Ae[xe][Ve] = !0), tt(Ae, Ve, He)) : B(Ae, Ve, He);
              }, re = function(Ae, Fe) {
                y(Ae);
                var He = E(Fe), Ve = C(He).concat(Te(He));
                ...
                var Fe = Q(E(Ae)), He = [];
                return be(Fe, function(Ve) {
                  !m(Z, Ve) && !m(he, Ve) && He.push(Ve);
                }), He;
              }, Te = function(Ae) {
                var Fe = Ae === x, He = Q(Fe ? ee : E(Ae)), Ve = [];
                return be(He, function(at) {
                  m(Z, at) && (!Fe || m(x, at)) && Ve.push(Z[at]);
                }), Ve;
              };
              if (h || (I = function() {
                if (this instanceof I) throw TypeError("Symbol is not a constructor");
                var Ae = !arguments.length || arguments[0] === void 0 ? void 0 : String(arguments[0]), Fe = ce(Ae), He = function(Ve) {
                  this === x && He.call(ee, Ve), m(this, xe) && m(this[xe], Fe) && (this[xe][Fe] = !1), tt(this, Fe, w(1, Ve));
                };
                ...
                return _e(ce(Ie), Ie);
              }), H.f = we, $.f = X, z.f = je, D.f = j.f = Pe, k.f = Te, Oe.f = function(Ie) {
                return _e(ye(Ie), Ie);
              }, d && (B(I[F], "description", {
                configurable: !0,
                get: function() {
            ...
            (function(i, c, r) {
              var s = r("0366"), o = r("44ad"), l = r("7b0b"), u = r("50c4"), d = r("65f0"), h = [].push, p = function(f) {
                ...
                return function(A, w, P, C) {
                  for (var D = l(A), j = o(D), k = s(w, P, 3), z = u(j.length), $ = 0, H = C || d, K = m ? H(A, z) : v ? H(A, 0) : void 0, Y, ae; z > $; $++) if ((E || $ in j) && (Y = j[$], ae = k(Y, $, D), f)) {
                    if (m) K[$] = ae;
                    else if (ae) switch (f) {
                      case 3:
                        return !0;
              ...
              function Q(G) {
                ...
                var Ae = we.flatMap(function(Fe, He) {
                  return Ie({
                    ...
                    return Ve.key = de(Fe), Ve.props = h(h({}, Ve.props || {}), {}, {
                      "data-draggable": !0
                    }), Ve;
                  });
                });
          ...
          fb6a: (
            ...
            (function(i, c, r) {
              ...
              s({ target: "Array", proto: !0, forced: !g || !y }, {
                slice: function(P, C) {
                  var D = h(this), j = d(D.length), k = u(P, j), z = u(C === void 0 ? j : C, j), $, H, K;
                  if (l(D) && ($ = D.constructor, typeof $ == "function" && ($ === Array || l($.prototype)) ? $ = void 0 : o($) && ($ = $[S], $ === null && ($ = void 0)), $ === Array || $ === void 0))
                    return E.call(D, k, z);
                  for (H = new ($ === void 0 ? Array : $)(A(z - k, 0)), K = 0; k < z; k++, K++) k in D && p(H, K, D[k]);
                  return H.length = K, H;
                }
              });
            })
    ...
    V("div", nm, [
      ...
      ie(Fa, { name: "fade" }, {
        default: Tt(() => [
          i.active ? (_(), oe("div", {
            key: 0,
            class: nt(["absolute right-0 top-full z-20 w-[200px] rounded bg-white shadow-xl ring-1 ring-neutral-100", n.classes])
          }, [
            xn(t.$slots, "dropdown")
          ], 2)) : Me("", !0)
        ]),
...
const Ml = /* @__PURE__ */ bt(em, [["render", om]]), am = {
  name: "VGrid",
  inject: ["bus"],
  components: { VActions: Ml, VToggle: ri, draggable: Vo },
  props: {
    modelValue: {
      type: Array,
      default: () => [
...
const Rm = { render: Pm }, Im = { class: "-field-title handle" }, Dm = ["onClick"], Fm = { class: "-title" }, Mm = { class: "-type-title" }, Lm = { class: "flex gap-6 items-center" }, Um = {
  key: 0,
  class: "-prop -options"
}, Nm = { class: "divide-y text-sm text-gray-700" }, jm = ["onClick"], km = { class: "-field-properties" }, Vm = { class: "-prop" }, $m = ["onUpdate:modelValue"], Bm = { class: "-prop" }, Hm = ["onUpdate:modelValue"], zm = { class: "-prop" }, Gm = ["onUpdate:modelValue", "placeholder"], Wm = { class: "-two-columns" }, Ym = { class: "-prop" }, Km = ["onUpdate:modelValue"], Xm = { class: "-prop -width" }, Jm = ["onUpdate:modelValue"], Qm = { class: "-prop" }, Zm = ["onUpdate:modelValue"], qm = {
  key: 0,
  class: "-prop"
          ...
          V("div", km, [
            f != null && f.builder ? (_(), Qt(Hn(f.builder), fu(Ma({ key: 0 }, { component: f })), null, 16)) : f.type === "grid" ? (_(), oe(Pt, { key: 1 }, [
              ...
              ["check-group", "radio-group", "signature", "file-upload"].includes(f.type) ? (_(), oe("div", ag, [
                ...
                V("div", cg, [
                  V("span", dg, $e(f.type === "heading" ? "Heading" : "Label"), 1),
                  et(V("input", {
                    type: "text",
                    "onUpdate:modelValue": (v) => f.label = v
                  }, null, 8, fg), [
            ...
            t.actions.length ? (_(), oe("div", Ig, [
              ...
              a.value[m] ? (_(), oe("div", Fg, [
                (_(!0), oe(Pt, null, bn(t.actions, (v) => {
                  var g;
                  return _(), oe("a", {
                    class: nt(["cursor-pointer hover:bg-brand-400 px-2 py-1 bg-brand-200 rounded-lg text-white", { "!bg-brand-700": (g = f == null ? void 0 : f.actions) == null ? void 0 : g.includes(v.value) }]),
...
}, Ng = { class: "p-6 w-[776px]" }, jg = { class: "fields" }, kg = { class: "draggable" }, Vg = { class: "mb-[20px] text-lg font-semibold text-gray-900" }, $g = { class: "fixed -bottom-8 right-0 flex justify-end gap-2 text-sm font-semibold bg-white w-full py-2 px-6 rounded-b-lg z-50" };
function Bg(t, e, n, a, i, c) {
  const r = on("field-draggable");
  return _(), oe("div", Ng, [
    V("div", jg, [
      V("div", kg, [
        V("h4", Vg, "Row " + $e(n.index + 1) + ": multiple columns", 1),
        ie(r, {
...
const oy = { class: "flex gap-4 mb-1 px-6 items-center" }, ay = ["href"], iy = ["textContent"], sy = { class: "flex justify-between items-center mb-6 px-6" }, ly = { class: "text-gray-900 text-[30px] font-semibold" }, uy = {
  key: 0,
...
}, my = { class: "flex" }, gy = { class: "form-builder" }, yy = { class: "form-builder-fields" }, by = { class: "settings" }, xy = {
  key: 0,
  ...
  key: 0,
  class: "text-red-600 text-sm mt-0.5 inline-block"
}, wy = { class: "flex w-1/3 flex-col" }, Ty = {
  key: 0,
  class: "p-6 mb-4 bg-gray-50 shadow-sm rounded-xl"
}, Ay = { class: "space-y-3" }, Oy = {
  width: "6",
  height: "6",
  viewBox: "0 0 6 6",
  fill: "none",
...
}, Ry = { class: "text-base" }, Iy = { class: "flex flex-col text-sm font-regular text-gray-900 gap-1" }, Dy = { class: "text-base" }, Fy = { class: "form-builder-templates overflow-y-auto" }, My = ["onClick"], Ly = { class: "relative group" }, Uy = ["innerHTML"], Ny = { class: "absolute hidden group-hover:block bg-black text-white text-sm rounded px-4 py-2 -top-16 left-0 w-[200px]" }, jy = {
  key: 2,
...
}, ky = { class: "flex gap-2" }, Vy = { key: 0 }, $y = {
  key: 1,
  ...
  setup(t) {
    ...
    const s = qe([]), o = qe(!1), l = qe(!1), u = qe(!1), d = qe(ry()), h = (P) => {
      r.value.map((C) => (["builder", "presenter"].forEach((D) => {
        const j = P == null ? void 0 : P.find((k) => C.hasOwnProperty(D) && k[D].__name === C[D].__name);
        j && (C[D] = rt(j[D]));
      }), C));
    };
    Fr(() => {
    ...
    const f = () => {
      ...
      try {
        ...
        u.value = !1, s.value = ((j = (D = k.response) == null ? void 0 : D.data) == null ? void 0 : j.errors) || [];
      }
    }, v = () => {
      o.value = !o.value;
      ...
      return ["hint", "placeholder", "class", "content", "content_type", "allow_add_row"].forEach((k) => {
        P.hasOwnProperty(k) && (D[k] = P[k]);
    ...
    return (P, C) => {
      ...
      return _(), oe(Pt, null, [
        ...
        V("div", sy, [
          V("h4", ly, $e(o.value ? "Preview" : Ze(i) ? Ze(i) : "Add New Form"), 1),
          V("a", {
            ...
            V("div", gy, [
              V("div", yy, [
                V("div", by, [
                  ...
                  V("div", null, [
                    ...
                    et(V("input", {
                      ...
                      "onUpdate:modelValue": C[0] || (C[0] = (k) => ea(i) ? i.value = k : i = k)
                    }, null, 512), [
                      [yt, Ze(i)]
                    ]),
                  ...
                  t.hasRecipient ? (_(), oe("div", Sy, [
                    ...
                    et(V("input", {
                      ...
                      "onUpdate:modelValue": C[1] || (C[1] = (k) => ea(c) ? c.value = k : c = k)
                    }, null, 512), [
                      [yt, Ze(c)]
                    ]),
                ...
                V("div", {
                  ...
                  V("div", {
                    class: nt(["draggable", { "!border-none !shadow-none": Ze(r).length }])
                  }, [
                    ie(Ll, {
                      modelValue: Ze(r),
                      "onUpdate:modelValue": C[2] || (C[2] = (k) => ea(r) ? r.value = k : r = k),
                      "is-dragging": l.value,
                      actions: t.actions
              ...
              V("div", wy, [
                Ze(a) ? (_(), oe("div", Ty, [
                  ...
                  V("div", Ay, [
                    V("div", {
                      class: nt(["px-3 py-1 text-sm text-gray-700 border font-medium border-warning-200 bg-warning-50 text-warning-700 rounded-full flex w-fit items-center gap-2", { "!text-success-700 !bg-success-50 !border-success-200": Ze(n).status === "published" }])
                    }, [
                      (_(), oe("svg", Oy, [
                        V("circle", {
                          cx: "3",
                    ...
                    Ze(n).status === "published" ? (_(), oe("div", Py, [
                      ...
                      V("label", Ry, $e(Ze(n).formatted_published_at), 1)
                    ])) : Me("", !0),
                    V("div", Iy, [
                      C[15] || (C[15] = V("label", null, " Last Modified ", -1)),
                      V("label", Dy, $e(Ze(n).last_modified), 1)
                    ])
                  ])
                ])) : Me("", !0),
                V("div", Fy, [
        ...
        o.value ? Me("", !0) : (_(), oe("div", jy, [
          ...
          V("div", ky, [
            V("a", {
              onClick: C[4] || (C[4] = ar((k) => m("draft"), ["prevent"])),
              class: "rounded-full cursor-pointer border border-brand-300 text-brand-700 hover:bg-brand-700 hover:text-white px-3 py-[7px]"
            }, [
              u.value ? (_(), oe("span", $y, [
                ie(Ze(ds), { class: "w-5 h-5 animate-spin text-white" })
              ])) : (_(), oe("span", Vy, " Save as draft "))
            ]),
            V("a", {
              onClick: C[5] || (C[5] = ar((k) => m("published"), ["prevent"])),
